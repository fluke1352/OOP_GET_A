...
public class image {
    ...
    public static BufferedImage ghosttop, Takaiboss;
...
//            System.out.println("A");
            ...
            map =  ImageIO.read(getClass().getResource("image/computer.jpg"));
            Takaiboss = ImageIO.read(getClass().getResource("image/Takaiboss.png"));
            kame = ImageIO.read(getClass().getResource("image/meme.png"));
            bskame = ImageIO.read(getClass().getResource("image/fireball.png"));
