...
public class Tubattleplayer extends JPanel implements KeyListener {
    ...
    public Tubattleplayer(int x, int y) {
        img = new image();
        this.x = x;
        this.y = y;
...
//            this.kx = this.x;
    ...
    public void checkhit() {
        if (HitBoxPlayer().intersects(Tubattleboss.getBossBulletBounds())) {
            Tubattleboss.kx = -20;
            Health.damage--;
