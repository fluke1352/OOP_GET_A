...
public class Macbattleplayer extends JPanel implements KeyListener {
    ...
    public Macbattleplayer(int x, int y) {
        img = new image();
        this.x = x;
        this.y = y;
...
//            this.kx = this.x;
    ...
    public void checkhit() {
        if (HitBoxPlayer().intersects(Macbattleboss.getBossBulletBounds())) {
            Macbattleboss.kx = -20;
            Health.damage--;
